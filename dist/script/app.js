angular.module('chatroom', ['ngRoute','angularMoment']).config(['$routeProvider','$locationProvider',function($routeProvider,$locationProvider){
    $routeProvider.when('/',{
...
angular.module('chatroom').controller('RoomCtrl',['$scope','$http','$location','$routeParams','socket','$rootScope',function($scope,$http,$location,$routeParams,socket,$rootScope){
...
angular.module('chatroom').directive('ctrlEnterBreakLine', function () {
    return {
...
angular.module('chatroom').factory('socket',function(){
